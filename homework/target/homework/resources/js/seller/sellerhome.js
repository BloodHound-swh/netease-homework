$(function() {
    // 获取此店铺下的商品列表的URL
    var listUrl = "/homework/productadmin/listsellerproduct";
    // 商品下架URL
    var statusUrl = '/homework/productadmin/changestatus';
    getList();
    /**
     * 获取此店铺下的商品列表
     *
        ...
        .on(
            ...
            function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/homework/productadmin/productoperation?productId='
                    ...
                    window.location.href = '/homework/productadmin/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
