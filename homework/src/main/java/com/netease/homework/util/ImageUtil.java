...
public class ImageUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Thumbnails.of(new File("/Users/bloodhound/Documents/homework/upload/images/item/shop/1/xiaohuangren.jpg"))
                .size(200, 200).watermark(Positions.BOTTOM_LEFT,
                ImageIO.read(new File(basePath + "/watermark.jpg")), 0.25f).outputQuality(0.8f)
                .toFile("/Users/bloodhound/Documents/homework/upload/images/item/shop/1/xhr.jpg");
    }
